...
class wpklikandpay_tools
{
	...
	*/
	function createDirectory($directory)
	{
		...
		wpklikandpay_tools::changeAccesAuthorisation($directory);
	}
	...
	*/
	function copyEntireDirectory($sourceDirectory, $destinationDirectory)
	{
		if(is_dir($sourceDirectory))
		{
			...
			{
				wpklikandpay_tools::createDirectory($destinationDirectory);
			}
			...
			while($item = readdir($hdir))
			{
				...
				{
					wpklikandpay_tools::copyEntireDirectory($sourceDirectory . '/' . $item, $destinationDirectory . '/' . $item);
				}
